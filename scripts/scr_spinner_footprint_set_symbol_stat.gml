///scr_spinner_footprint_set_symbol_stat(player,symbol state, weight, weight2, weight3, weight4, weight5)

var player = argument0 - 1;
var state = argument1;
var w = argument2;
var w2 = argument3;
var w3 = argument4;
...
ds_map_replace(symbolStats[player],state,input)
